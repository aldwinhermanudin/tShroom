...
int main(int argc, char** argv){
	...
	image_transport::Publisher pub_video = it.advertise("/tshroom/video", 1, true); 	// topic: auvsi16/video; Queue: 1; Latch :true
...
void setCameraConfiguration(){
	...
	if (v4l2_configuration == 0){
		ROS_INFO("[VF] V4L2 Configuration Disabled");
	}
	else if (v4l2_configuration == 1){
		ROS_INFO("[VF] V4L2 Configuration Enabled\n");
